...
class RepoOrders implements RepoCrud{
    ...
    public function create($order) {
        ...
        $stmt = $this->conexion->prepare("INSERT INTO Orders (datetime, state, totalPrice, userID, addressJson, orderLinesJson) VALUES (:datetime, :state, :totalPrice, :userID, :addressJson, :orderLinesJson)");
            
        $stmt->execute(["datetime" => $order->getDatetime(),"state" => $order->getState(),"totalPrice" => $order->getTotalPrice(),"userID" => $order->getUserID(),"addressJson" => $order->getAddressJson(),"orderLinesJson" => $order->getOrderLinesJson()]);
